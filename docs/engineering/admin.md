...
> The recipe node editor described below is **frozen** ([D4, D8](../product/decisions.md)). Recipes are now files in the repository; editor records are not used by asset creation flows. The read-only admin views remain useful.
