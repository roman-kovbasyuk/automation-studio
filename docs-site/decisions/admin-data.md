...
**Status:** V1 admin visibility and recipe storage implemented; broader runtime model remains planned. **Updated:** 10 September 2026.
...
Read the [detailed backend proposal](/decisions/backend-reference) for invariants and the [delivery stages](/decisions/delivery) for ordering.
