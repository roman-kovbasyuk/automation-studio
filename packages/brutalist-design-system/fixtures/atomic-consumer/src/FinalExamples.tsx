...
export function FinalExamples() {
  ...
  const [keywords, setKeywords] = useState(['winter light'])
  ...
  return <C.Stack gap={8}>
    ...
    <C.TagInput label="Keywords" value={keywords} onChange={setKeywords} placeholder="Add a keyword" />
