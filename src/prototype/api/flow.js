  ...
  async function runGeneration(campaignId, step, input = {}, idempotencyKey) {
    ...
    const result = step === 'brief' || step === 'brief_analysis'
      ? { analysis: {
        ...
        summary: workspace.campaign.brief.notes || 'A calm campaign for everyday focus.', audience: workspace.campaign.brief.audience || 'Commuters', copyMode: 'create_new', ageGroups: ['25_34', '35_44'], gender: 'all', reach: 'national', goal: null, goalCustom: '', visualTags: ['Calm', 'Daylight'],
        } },
      } }
      : step === 'copy'
