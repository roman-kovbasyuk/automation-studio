...
This page describes the banner flow as it is built today: six modules in `src/studio/campaign/`. The target model replaces it with the four-stage [asset creation flow](../product/concept.md) driven by [recipe files](../product/recipes.md), with designer review as an escalation path. Use this page to work on the existing code; use the product pages for what to build next.

| Current module | Target stage |
| --- | --- |
| Brief | Brief |
| Copy | Copy |
| Visuals | Visuals |
| Banners, Review, Distribute | Assets (Review becomes escalation) |
...
The connected UI test exercises designer feedback, pointer/keyboard reopening, independent approval and the exact delivered ZIP through the real API. This uses jsdom. A separate physical-browser run completed the same feedback/reopen/version-2 loop and downloaded a verified square-and-portrait PNG package. All six modules were inspected at 2252, 1440 and 390px with no horizontal page overflow; keyboard navigation, preview focus return, mobile timeline/drawer, isolated error/retry and delivered-state reload were checked. These checks do not certify paid providers, cloud storage, Firebase login, external publishing or browser speed gains.
