...
**Status:** Current implementation (local rollout) · **Updated:** 15 September 2026

How the Brief stage reads uploaded materials today. In the target model this becomes the `analyseMaterials` and `confirmBrief` capabilities of every recipe.
