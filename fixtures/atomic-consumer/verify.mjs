...
assert.deepEqual(Object.keys(coveredBlocks).sort(), ['PromptInput','SidebarPanel'])
...
for (const marker of ['b-sidebar','c-attachment-area','AI prompt input']) assert.ok(html.includes(marker))
